...
const agency = readFile('./static-data/agency.txt');
const calendar_datas = readFile('./static-data/calendar_dates.txt');
const calendar = readFile('./static-data/calendar.txt');
const feed_info = readFile('./static-data/feed_info.txt');
const routes = readFile('./static-data/routes.txt').filter(route => route.route_type === "3"); // get only bus routes
const shapes = readFile('./static-data/shapes.txt');
const stop_times = readFile('./static-data/stop_times.txt');
const stops = readFile('./static-data/stops.txt');
const trips = readFile('./static-data/trips.txt');
